    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (request.getParameter("password").equals(request.getParameter("password2"))) {
                ...
                oneUser.setFirst_name(request.getParameter("first_name"));
                oneUser.setLast_name(request.getParameter("last_name"));
                oneUser.setGroup(request.getParameter("group"));
                UsersDB myUserDB = new UsersDB();

                ServletContext context = getServletContext();
                if (myUserDB.register(oneUser)) {
